    ...
    <div className="container" id="welcomepage">
      ...
      <div className="content2" id="content2">
        ...
        <form onSubmit={handleSubmit}>
                  ...
                  <label key={value}>
                    ...
                    <span
                      style={{
                        fontSize: "1.5rem",
                        color:
                          value <= formData.Practical1 ? "#FFD700" : "#ccc",
                      }}
                    >
                      ★
                    </span>
                  ...
                  <label key={value}>
                    ...
                    <span
                      style={{
                        fontSize: "1.5rem",
                        color:
                          value <= formData.Practical2 ? "#FFD700" : "#ccc",
                      }}
                    >
                      ★
                    </span>
                  ...
                  <label key={value}>
                    ...
                    <span
                      style={{
                        fontSize: "1.5rem",
                        color:
                          value <= formData.Practical3 ? "#FFD700" : "#ccc",
                      }}
                    >
                      ★
                    </span>
                  ...
                  <label key={value}>
                    ...
                    <span
                      style={{
                        fontSize: "1.5rem",
                        color:
                          value <= formData.Practical4 ? "#FFD700" : "#ccc",
                      }}
                    >
                      ★
                    </span>
                  ...
                  <label key={value}>
                    ...
                    <span
                      style={{
                        fontSize: "1.5rem",
                        color:
                          value <= formData.Practical5 ? "#FFD700" : "#ccc",
                      }}
                    >
                      ★
                    </span>
                  ...
                  <label key={value}>
                    ...
                    <span
                      style={{
                        fontSize: "1.5rem",
                        color:
                          value <= formData.Practical6 ? "#FFD700" : "#ccc",
                      }}
                    >
                      ★
                    </span>
            ...
            <div className="rating">
              <label>
                <b>
                  ...
                  with their practical tasks when they encountered difficulties?
                </b>
              </label>
                  ...
                  <label key={value}>
                    ...
                    <span
                      style={{
                        fontSize: "1.5rem",
                        color:
                          value <= formData.Practical7 ? "#FFD700" : "#ccc",
                      }}
                    >
                      ★
                    </span>
          ...
          {/* COMMENT SECTION */}
          <label htmlFor="PracticalComment">
