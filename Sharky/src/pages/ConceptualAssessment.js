...
const ConceptualAssessment = () => {
  ...
  return (
    <div className="container" id="welcomepage">
      ...
      <main>{/* Main content or additional logic can go here */}</main>
        ...
        <form onSubmit={handleSubmit}>
                  ...
                  <label key={value}>
                    ...
                    <span
                      style={{
                        fontSize: "1.5rem",
                        color:
                          value <= formData.Conceptual1 ? "#FFD700" : "#ccc",
                      }}
                    >
                      ★
                    </span>
                  ...
                  <label key={value}>
                    ...
                    <span
                      style={{
                        fontSize: "1.5rem",
                        color:
                          value <= formData.Conceptual2 ? "#FFD700" : "#ccc",
                      }}
                    >
                      ★
                    </span>
                  ...
                  <label key={value}>
                    ...
                    <span
                      style={{
                        fontSize: "1.5rem",
                        color:
                          value <= formData.Conceptual3 ? "#FFD700" : "#ccc",
                      }}
                    >
                      ★
                    </span>
          ...
          <div className="form-group">
            <div className="rating">
              <label>
                <b>
                  4. How well did the team member integrated various ideas
                  within the team?
                </b>
              </label>
                  ...
                  <label key={value}>
                    ...
                    <span
                      style={{
                        fontSize: "1.5rem",
                        color:
                          value <= formData.Conceptual4 ? "#FFD700" : "#ccc",
                      }}
                    >
                      ★
                    </span>
                  ...
                  <label key={value}>
                    ...
                    <span
                      style={{
                        fontSize: "1.5rem",
                        color:
                          value <= formData.Conceptual5 ? "#FFD700" : "#ccc",
                      }}
                    >
                      ★
                    </span>
            ...
            <div className="rating">
              <label>
                <b>
                  ...
                  integrating effective solutions to advance the project?{" "}
                </b>
              </label>
                  ...
                  <label key={value}>
                    ...
                    <span
                      style={{
                        fontSize: "1.5rem",
                        color:
                          value <= formData.Conceptual6 ? "#FFD700" : "#ccc",
                      }}
                    >
                      ★
                    </span>
                  ...
                  <label key={value}>
                    ...
                    <span
                      style={{
                        fontSize: "1.5rem",
                        color:
                          value <= formData.Conceptual7 ? "#FFD700" : "#ccc",
                      }}
                    >
                      ★
                    </span>
          ...
          {/* COMMENT SECTION */}
          <label htmlFor="ConceptualComment">
